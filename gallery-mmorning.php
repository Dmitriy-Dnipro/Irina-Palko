<?php
/*
 Template Name: Галерея — Мотивационный завтрак
 */
?>
<?php
    get_header(); 
    ...
    <div class="container">
				...
				<div class="projects">
					<ul class="projects-filter">
                        ...
                        <li class="active text-center">
							<a href="#">Мотивационный Завтрак</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-offset-1 col-md-10 tab-content">
                <div class="common-projects-wrapper" id="motivacionnyi-zavtrak">
					...
					<a class="fb-link" href="//www.facebook.com/pg/Motivational.Breakfast/photos/">Смотреть больше в facebook</a>
				</div>
			</div><!-- tab-content -->
		</div> <!-- row -->
	</div> <!-- container -->
