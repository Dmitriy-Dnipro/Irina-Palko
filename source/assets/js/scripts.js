$(document).ready(function(){
    ...
    $('div.blockWrapper a.block').hover(function(){
		//var tab_id = $(this).attr('data-tab');

		$('div.blockWrapper a.block').removeClass('current');
		//$('.tab-content').removeClass('current');
...
$(function () {
    $(".all-blogs .post-wrapper").addClass('hidden');

    $(".all-blogs .post-wrapper").slice(0, 4).removeClass('hidden');
    $(".all-blogs-button").on('click', function (e) {
        e.preventDefault();
        $(".all-blogs .post-wrapper:hidden").slice(0, 4).removeClass('hidden');
        if ($(".all-blogs .post-wrapper:hidden").length == 0) {
            $(".all-blogs-button").hide();
        }
    });
    if ($(".all-blogs .post-wrapper:hidden").length == 0) {
        $(".all-blogs-button").hide();
...
$(document).ready(function(){
    ...
    $('.swiper-slide').equivalent();
    $('.wrapperMorning svg').equivalent();
